...
function addGamesToPage(games) {
  ...
  for (let game of games) {
    ...
    gameCard.innerHTML = `<h5> ${game.name}: </h5> 
...
const totalContributions = GAMES_JSON.reduce((contributionsCard, game) => {
  return contributionsCard + game.backers;
}, 0);
...
const displayStr = `A total of $${totalContributions} has been raised for 
                    ${totalGames} games. Currently, ${numUnfundedGames} game${
  numUnfundedGames === 1 ? " remains" : "s remain"
}
